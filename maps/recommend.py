...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    return group_by_first(zip([find_closest((restaurant_location(r)), centroids) for r in restaurants],restaurants))
    # END Question 4
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        centroids = [find_centroid(c) for c in group_by_centroid(restaurants, old_centroids)]
        # END Question 6
        n += 1
    return centroids
...
def rate_all(user, restaurants, feature_fns):
    ...
    for r in restaurants:
        if r in reviewed:
            allrating[restaurant_name(r)] = user_rating(user, restaurant_name(r))
        else:
            allrating[restaurant_name(r)] = predictor(r)
    return allrating
    # END Question 9
